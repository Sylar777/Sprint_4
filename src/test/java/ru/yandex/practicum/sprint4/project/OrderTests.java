...
public class OrderTests {
    ...
    public static Object[][] getCities() {
        ...
        return new Object[][] {
                { "Имятест", "Фамилиятест", "Адресстест 3", "Бульвар Рокоссовского", "+7915234564", "04.11.2022",
                        "сутки", "тест коммент" },
                { "Васька", "Пупкин", "Мой адресс простой 3", "Лихоборы", "+7916233337", "09.11.2021", "семеро суток",
                        "тест коммент он и в Африке тест коммент" }
        };
    }
    ...
    public void checkPositiveFlowThroughUpperButtonAndBlackPearlCheckbox() {
        ...
        orderPage.populateFirstPage(firstName, lastName, address, subwayStation, phoneNumber)
                .clickContinueButton()
                .populateSecondPageWithOutCheckbox(date, dropdownRent, comments)
                .selectBlackPearlCheckbox()
                .clickOrderButtons()
                .clickYesButtons()
                .checkThatOrderSubmited();
    }
    ...
    public void checkPositiveFlowThroughBottomButtonAndGrayHopelessnessCheckbox() {
        ...
        orderPage.populateFirstPage(firstName, lastName, address, subwayStation, phoneNumber)
                .clickContinueButton()
                .populateSecondPageWithOutCheckbox(date, dropdownRent, comments)
                .selectGrayHopelessnessCheckbox()
                .clickOrderButtons()
                .clickYesButtons()
                .checkThatOrderSubmited();
    }
